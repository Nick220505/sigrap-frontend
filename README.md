...
The application supports multiple languages (English and Spanish) using ngx-translate. For detailed information on adding translations and working with internationalization:

- See [Internationalization Guide](docs/INTERNATIONALIZATION.md)
