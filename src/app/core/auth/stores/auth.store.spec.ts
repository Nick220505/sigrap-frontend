...
describe('AuthStore', () => {
    ...
    describe('login', () => {
        ...
        it('should update state and navigate on successful login', () => {
            ...
            expect(localStorage.getItem('user_data')).toBe(JSON.stringify({
                email: mockResponse.email,
                name: mockResponse.name,
                lastLogin: mockResponse.lastLogin,
                role: mockResponse.role,
        ...
        it('should handle error on login failure', () => {
            authService.login.mockReturnValue(throwError(() => new Error('Failed to login')));
    ...
    describe('register', () => {
        ...
        it('should handle error on registration failure', () => {
            authService.register.mockReturnValue(throwError(() => new Error('Failed to register')));
