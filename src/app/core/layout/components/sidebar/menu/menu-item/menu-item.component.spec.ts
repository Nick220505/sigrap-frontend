...
describe('MenuItemComponent', () => {
    ...
    function setupComponent(inputs: {
        ...
        fixture.componentRef.setInput('item', inputs.item ?? { label: 'Default Item' });
    ...
    describe('Initialization', () => {
        ...
        it('should call updateActiveStateFromRoute if item has a routerLink', () => {
            vi.spyOn(MenuItemComponent.prototype, 'updateActiveStateFromRoute');
    ...
    describe('Item rendering', () => {
        it('should render root item label when root is true', () => {
            ...
            const rootTextEl = fixture.debugElement.query(By.css('.layout-menuitem-root-text'));
        ...
        it('should render item with URL', () => {
            ...
            const textEl = fixture.debugElement.query(By.css('.layout-menuitem-text'));
        ...
        it('should render item with submenu items', () => {
            ...
            const submenuToggler = fixture.debugElement.query(By.css('.layout-submenu-toggler'));
        ...
        it('should not render when visible is false', () => {
            ...
            const itemEl = fixture.debugElement.query(By.css('.layout-menuitem-text'));
    ...
    describe('Cleanup', () => {
        it('should unsubscribe from subscriptions on destroy', () => {
            setupComponent({});
            const menuSourceSpy = vi.spyOn(component['menuSourceSubscription'], 'unsubscribe');
            const menuResetSpy = vi.spyOn(component['menuResetSubscription'], 'unsubscribe');
    ...
    describe('Item visibility and rendering', () => {
        it('should not render when item visible is false', () => {
            ...
            fixture.detectChanges();
            const menuItem = fixture.debugElement.query(By.css('.layout-menuitem-text'));
        ...
        it('should add badge when item has badge', () => {
            ...
            const labelEl = fixture.debugElement.query(By.css('.layout-menuitem-text'));
    ...
    describe('Key handling and DOM testing', () => {
        it('should use item.label in html rendering', () => {
            ...
            const labelEl = fixture.debugElement.query(By.css('.layout-menuitem-text'));
            expect(labelEl.nativeElement.textContent.trim()).toBe('Custom Label Text');
        });
