        ...
        <div class="pt-2 flex gap-2 flex-wrap justify-start">
          @for (primaryColor of primaryColors(); track primaryColor.name) {
            <button
              ...
              [attr.aria-label]="'Select ' + primaryColor.name + ' color'"
            ...
            >
              <span class="sr-only">{{ primaryColor.name }}</span>
            </button>
          }
        </div>
      </div>
        ...
        <div class="pt-2 flex gap-2 flex-wrap justify-start">
          @for (surface of surfaces; track surface.name) {
            <button
              type="button"
              [title]="surface.name"
              [attr.aria-label]="'Select ' + surface.name + ' surface'"
            ...
            >
              <span class="sr-only">{{ surface.name }}</span>
            </button>
          }
        </div>
      </div>
