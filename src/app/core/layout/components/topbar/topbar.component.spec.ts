...
import { ElementRef, NO_ERRORS_SCHEMA, signal, WritableSignal, } from '@angular/core';
...
import { LayoutConfig, LayoutService, } from '@core/layout/services/layout.service';
...
describe('TopbarComponent', () => {
    ...
    it('should toggle user menu visibility on user button click', () => {
        ...
        const userButton = fixture.debugElement.query(By.css('button[pTooltip="Profile"]'));
    ...
    it('should display user info when user menu is visible', () => {
        ...
        const userInfoDiv = fixture.debugElement.query(By.css('.absolute .border-b'));
    ...
    it('should call confirmLogout when logout button is clicked', () => {
        ...
        const logoutButtonIcon = fixture.debugElement.query(By.css('button .pi-sign-out'));
    ...
    it('should NOT close user menu when clicking inside', () => {
        ...
        (elementRef.nativeElement.querySelector as Mock).mockImplementation((selector: string) => {
            if (selector === '#userMenuContainer') {
                return userMenuContainerDiv;
            }
            return null;
        });
        (userMenuContainerDiv as HTMLElement).contains = vi.fn().mockReturnValue(true);
