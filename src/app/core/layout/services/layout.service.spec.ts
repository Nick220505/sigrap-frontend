...
describe('LayoutService', () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(serviceWithPrivate, 'handleDarkModeTransition').mockImplementation((config) => {
    ...
    describe('storage handling', () => {
        ...
        it('should save theme settings to localStorage', () => {
            ...
            expect(localStorageSpy.setItem).toHaveBeenCalledWith('layout-config', expect.any(String));

            const savedJson = (localStorageSpy.setItem as Mock).mock.calls[0][1] as string;
        ...
        it('should handle localStorage errors gracefully', () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Error loading theme from storage:', expect.any(Error));
        });
        ...
        it('should handle localStorage save errors gracefully', () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Error saving theme to storage:', expect.any(Error));
        });
    });
    ...
    describe('theme mode handling', () => {
        it('should update layout configuration when toggling dark mode', () => {
            ...
            expect(service.layoutConfig().themeMode).toBe(initialConfig.darkTheme ? 'light' : 'dark');
    ...
    describe('configuration and event handling', () => {
        it('should update config and emit update event', () => {
            ...
            expect(service['configUpdate'].next).toHaveBeenCalledWith(service.layoutConfig());
        });
    ...
    describe('cleanup', () => {
        it('should cleanup timeCheckInterval on destroy', () => {
            ...
            service['timeCheckInterval'] = fakeInterval as unknown as ReturnType<typeof setInterval>;
