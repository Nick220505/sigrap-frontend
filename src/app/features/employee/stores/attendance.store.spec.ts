...
import { AttendanceInfo, AttendanceStatus, ClockInData, ClockOutData, } from '../models/attendance.model';
...
describe('AttendanceStore', () => {
    ...
    describe('findAll', () => {
        ...
        it('should handle error when findAll fails', () => {
            attendanceService.findAll.mockReturnValue(throwError(() => new Error('Error loading attendances')));
    ...
    describe('findByEmployeeId', () => {
        ...
        it('should handle error when findByEmployeeId fails', () => {
            attendanceService.findByEmployeeId.mockReturnValue(throwError(() => new Error('Error loading employee attendances')));
    ...
    describe('clockIn', () => {
        ...
        it('should handle error when clocking in fails', () => {
            attendanceService.clockIn.mockReturnValue(throwError(() => new Error('Error clocking in')));
    ...
    describe('clockOut', () => {
        ...
        it('should handle error when clocking out fails', () => {
            attendanceService.clockOut.mockReturnValue(throwError(() => new Error('Error clocking out')));
