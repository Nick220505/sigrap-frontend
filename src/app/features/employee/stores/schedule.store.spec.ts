...
describe('ScheduleStore', () => {
    ...
    describe('findAll', () => {
        ...
        it('should handle error when findAll fails', () => {
            scheduleService.findAll.mockReturnValue(throwError(() => new Error('Error loading schedules')));
    ...
    describe('findByEmployeeId', () => {
        ...
        it('should handle error when findByEmployeeId fails', () => {
            scheduleService.findByEmployeeId.mockReturnValue(throwError(() => new Error('Error loading employee schedules')));
    ...
    describe('findById', () => {
        ...
        it('should handle error when findById fails', () => {
            scheduleService.findById.mockReturnValue(throwError(() => new Error('Error loading schedule')));
    ...
    describe('create', () => {
        ...
        it('should handle error when creating schedule fails', () => {
            scheduleService.create.mockReturnValue(throwError(() => new Error('Error creating schedule')));
    ...
    describe('update', () => {
        ...
        it('should handle error when updating schedule fails', () => {
            scheduleService.update.mockReturnValue(throwError(() => new Error('Error updating schedule')));
    ...
    describe('delete', () => {
        ...
        it('should handle error when deleting schedule fails', () => {
            scheduleService.delete.mockReturnValue(throwError(() => new Error('Error deleting schedule')));
    ...
    describe('deleteAllById', () => {
        ...
        it('should handle error when deleting multiple schedules fails', () => {
            scheduleService.deleteAllById.mockReturnValue(throwError(() => new Error('Error deleting schedules')));
