...
import { PurchaseOrderData, PurchaseOrderInfo, } from '../models/purchase-order.model';
...
describe('PurchaseOrderService', () => {
    ...
    it('should mark a purchase order as delivered', () => {
        ...
        const req = httpMock.expectOne(`${apiUrl}/1/deliver?actualDeliveryDate=${deliveryDate}`);
        expect(req.request.method).toBe('PATCH');
        expect(req.request.body).toEqual({});
        req.flush(mockPurchaseOrder);
    });
