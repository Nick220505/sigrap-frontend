...
import { PurchaseOrderData, PurchaseOrderInfo, PurchaseOrderItemData, } from '../models/purchase-order.model';
...
describe('PurchaseOrderStore', () => {
    ...
    beforeEach(() => {
        purchaseOrderService = {
            ...
            findBySupplierId: vi.fn().mockName("PurchaseOrderService.findBySupplierId"),
        ...
        purchaseOrderService.findBySupplierId.mockReturnValue(of([mockPurchaseOrder]));
    ...
    describe('findAll', () => {
        ...
        it('should handle error when findAll fails', () => {
            purchaseOrderService.findAll.mockReturnValue(throwError(() => new Error('Error loading orders')));
    ...
    describe('findBySupplierId', () => {
        ...
        it('should handle error when findBySupplierId fails', () => {
            purchaseOrderService.findBySupplierId.mockReturnValue(throwError(() => new Error('Error loading supplier orders')));
    ...
    describe('findByStatus', () => {
        ...
        it('should handle error when findByStatus fails', () => {
            purchaseOrderService.findByStatus.mockReturnValue(throwError(() => new Error('Error loading orders by status')));
    ...
    describe('create', () => {
        it('should create a purchase order', () => {
            ...
            expect(purchaseOrderService.create).toHaveBeenCalledWith(mockPurchaseOrderData);
        ...
        it('should handle error when creating a purchase order fails', () => {
            purchaseOrderService.create.mockReturnValue(throwError(() => new Error('Error creating order')));
    ...
    describe('update', () => {
        it('should update a purchase order', () => {
            ...
            expect(purchaseOrderService.update).toHaveBeenCalledWith(1, mockPurchaseOrderData);
            expect(messageService.add).toHaveBeenCalledWith({
                severity: 'success',
        ...
        it('should handle error when updating a purchase order fails', () => {
            purchaseOrderService.update.mockReturnValue(throwError(() => new Error('Error updating order')));
    ...
    describe('submitOrder', () => {
        ...
        it('should handle error when submitting an order fails', () => {
            purchaseOrderService.submitOrder.mockReturnValue(throwError(() => new Error('Error submitting order')));
    ...
    describe('delete', () => {
        ...
        it('should handle error when deleting a purchase order fails', () => {
            purchaseOrderService.delete.mockReturnValue(throwError(() => new Error('Error deleting order')));
    ...
    describe('deleteAllById', () => {
        ...
        it('should handle error when deleting multiple orders fails', () => {
            purchaseOrderService.delete.mockReturnValue(throwError(() => new Error('Error deleting orders')));
    ...
    describe('confirmOrder', () => {
        ...
        it('should handle error when confirming an order fails', () => {
            purchaseOrderService.confirmOrder.mockReturnValue(throwError(() => new Error('Error confirming order')));
    ...
    describe('markAsShipped', () => {
        ...
        it('should handle error when marking an order as shipped fails', () => {
            purchaseOrderService.markAsShipped.mockReturnValue(throwError(() => new Error('Error marking as shipped')));
    ...
    describe('markAsDelivered', () => {
        it('should mark a purchase order as delivered', () => {
            ...
            expect(purchaseOrderService.markAsDelivered).toHaveBeenCalledWith(1, deliveryDate);
            expect(messageService.add).toHaveBeenCalledWith({
                severity: 'success',
        ...
        it('should handle error when marking an order as delivered fails', () => {
            purchaseOrderService.markAsDelivered.mockReturnValue(throwError(() => new Error('Error marking as delivered')));
    ...
    describe('cancelOrder', () => {
        ...
        it('should handle error when canceling an order fails', () => {
            purchaseOrderService.cancelOrder.mockReturnValue(throwError(() => new Error('Error canceling order')));
            store.cancelOrder(1);
