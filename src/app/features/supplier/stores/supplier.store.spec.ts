...
describe('SupplierStore', () => {
    ...
    describe('findAll', () => {
        ...
        it('should handle error when findAll fails', () => {
            supplierService.findAll.mockReturnValue(throwError(() => new Error('Error loading suppliers')));
    ...
    describe('create', () => {
        ...
        it('should handle error when creating supplier fails', () => {
            supplierService.create.mockReturnValue(throwError(() => new Error('Error creating supplier')));
    ...
    describe('update', () => {
        ...
        it('should handle error when updating supplier fails', () => {
            supplierService.update.mockReturnValue(throwError(() => new Error('Error updating supplier')));
        ...
        it('should handle foreign key constraint error when deleting supplier', () => {
            const errorResponse = new HttpErrorResponse({
                error: {
                    ...
                    message: 'update or delete on table "suppliers" violates foreign key constraint',
                },
                status: HttpStatusCode.Conflict,
            });
            ...
            expect(messageService.add).toHaveBeenCalledWith({
                severity: 'error',
                summary: 'Error',
                detail: 'Cannot delete supplier "Test Supplier" because it is being used.',
            });
        });
    });
    ...
    describe('deleteAllById', () => {
        ...
        it('should handle foreign key constraint error when deleting multiple suppliers', () => {
            const errorResponse = new HttpErrorResponse({
                error: {
                    status: HttpStatusCode.Conflict,
                    message: 'update or delete on table "suppliers" violates foreign key constraint Key (id)=(1)',
                },
                status: HttpStatusCode.Conflict,
            });

            supplierService.deleteAllById.mockReturnValue(throwError(() => errorResponse));
