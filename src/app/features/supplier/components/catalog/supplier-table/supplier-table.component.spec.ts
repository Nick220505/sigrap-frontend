...
describe('SupplierTableComponent', () => {
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [SupplierTableComponent, FormsModule],
            providers: [
                { provide: SupplierStore, useValue: supplierStore },
                { provide: ConfirmationService, useValue: confirmationService },
            ],
        })
            .overrideComponent(SupplierTableComponent, {
            set: {
                imports: [FormsModule],
                template: '',
            },
    ...
    describe('Delete functionality', () => {
        it('should show confirmation dialog when deleteSupplier is called', () => {
            ...
            expect(confirmOptions.message).toBe('Are you sure you want to delete the supplier <b>Supplier 1</b>?');
        });
