...
describe('ProductTableComponent', () => {
    ...
    describe('Table initialization', () => {
        ...
        it('should display the correct product data in each row', () => {
            ...
            expect(firstRowCells[1].nativeElement.textContent.trim()).toBe('Product 1');
            expect(firstRowCells[2].nativeElement.textContent.trim()).toBe('Description 1');
        });
    ...
    describe('Edit functionality', () => {
        it('should call openProductDialog when edit button is clicked', () => {
            ...
            expect(productStore.openProductDialog).toHaveBeenCalledWith(mockProducts[0]);
        });
    ...
    describe('Delete functionality', () => {
        ...
        it('should show confirmation dialog when deleteProduct is called', () => {
            ...
            expect(confirmOptions.message).toBe('Are you sure you want to delete the product <b>Product 1</b>?');
        });
    ...
    describe('Error state', () => {
        it('should display error message when there is an error', () => {
            (productStore.error as WritableSignal<string | null>).set('Test error message');
            (productStore.entities as WritableSignal<ProductInfo[]>).set([]);
            fixture.detectChanges();
    ...
    describe('Empty state', () => {
        it('should display empty message when there are no products and no error', () => {
            ...
            expect(emptyMessage.nativeElement.textContent).toContain('No products found.');
        });
    });
});
