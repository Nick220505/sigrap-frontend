...
describe('ProductDialogComponent', () => {
    ...
    beforeEach(async () => {
        ...
        productStore = {
            ...
            closeProductDialog: vi.fn().mockName("ProductStore.closeProductDialog"),
            create: vi.fn().mockName("ProductStore.create"),
            update: vi.fn().mockName("ProductStore.update"),
    ...
    describe('Dialog visibility and header', () => {
        ...
        it('should show "Create Product" header when no product is selected', () => {
            (productStore.dialogVisible as WritableSignal<boolean>).set(true);
            (productStore.selectedProduct as WritableSignal<ProductInfo | null>).set(null);
            fixture.detectChanges();

            const dialogHeader = fixture.debugElement.query(By.css('.p-dialog-title'));
            expect(dialogHeader.nativeElement.textContent.trim()).toBe('Create Product');
        });
        ...
        it('should show "Edit Product" header when a product is selected', () => {
            ...
            const dialogHeader = fixture.debugElement.query(By.css('.p-dialog-title'));
            expect(dialogHeader.nativeElement.textContent.trim()).toBe('Edit Product');
        });
    ...
    describe('Effect and form reactivity', () => {
        it('should patch form values when editing an existing product', () => {
            (productStore.selectedProduct as WritableSignal<ProductInfo | null>).set({
                id: 1,
                name: 'Product 1',
                description: 'Description 1',
            ...
            expect(component.productForm.get('description')?.value).toBe('Description 1');
    ...
    describe('Form operations', () => {
        ...
        it('should patch form with specific values', () => {
            ...
            expect(component.productForm.get('description')?.value).toBe('Patched Description');
    ...
    describe('Form validation and error display', () => {
        ...
        it('should show validation error when costPrice is empty and field is touched', () => {
            ...
            const errorMessage = fixture.debugElement.query(By.css('.text-red-500'));
            expect(errorMessage).toBeTruthy();
            expect(errorMessage.nativeElement.textContent).toContain('Cost price is required');
        });
        ...
        it('should show validation error when salePrice is empty and field is touched', () => {
            ...
            const errorMessage = fixture.debugElement.query(By.css('.text-red-500'));
            expect(errorMessage).toBeTruthy();
            expect(errorMessage.nativeElement.textContent).toContain('Sale price is required');
        });
        ...
        it('should apply ng-invalid and ng-dirty classes to invalid fields', () => {
            ...
            expect(nameInput.nativeElement.classList.contains('ng-invalid')).toBe(true);
    ...
    describe('Loading state', () => {
        it('should reflect loading state from store', () => {
            ...
            expect(component.productStore.loading()).toBe(true);
