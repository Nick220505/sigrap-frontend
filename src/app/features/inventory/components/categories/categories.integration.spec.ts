...
import { CategoryData, CategoryInfo, } from '@features/inventory/models/category.model';
...
describe('Categories Feature Integration', () => {
    ...
    it('should load and display categories on initialization', () => {
        ...
        const tableElement = fixture.nativeElement.querySelector('app-category-table');
    ...
    it('should open the category dialog when "Create Category" button is clicked', () => {
        ...
        const createButton = fixture.nativeElement.querySelector('app-category-toolbar button');
        createButton.click();
        fixture.detectChanges();
        ...
        const dialog = fixture.nativeElement.querySelector('app-category-dialog p-dialog');
    ...
    it('should create a new category successfully', () => {
        ...
        expect(component.categoryStore.entities().find((c) => c.id === 4)).toEqual(createdCategory);
    ...
    it('should update an existing category successfully', () => {
        ...
        expect(component.categoryStore.dialogVisible()).toBe(true);
        expect(component.categoryStore.selectedCategory()).toEqual(mockCategories[0]);
        ...
        expect(component.categoryStore.entities().find((c) => c.id === 1)).toEqual(updatedCategory);
    ...
    it('should delete a category successfully', () => {
        ...
        expect(component.categoryStore.entities().find((c) => c.id === 1)).toBeUndefined();
    ...
    it('should delete multiple categories successfully', () => {
        ...
        const deleteReq = httpTestingController.expectOne(`${categoriesUrl}/delete-many`);
        expect(deleteReq.request.method).toBe('DELETE');
        ...
        expect(component.categoryStore.entities().find((c) => c.id === 1)).toBeUndefined();
        expect(component.categoryStore.entities().find((c) => c.id === 2)).toBeUndefined();
        expect(component.categoryStore.entities().find((c) => c.id === 3)).toBeTruthy();
