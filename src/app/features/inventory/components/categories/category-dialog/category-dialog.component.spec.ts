...
describe('CategoryDialogComponent', () => {
    ...
    beforeEach(async () => {
        ...
        categoryStore = {
            ...
            closeCategoryDialog: vi.fn().mockName("CategoryStore.closeCategoryDialog"),
    ...
    describe('Dialog visibility and header', () => {
        ...
        it('should show "Create Category" header when no category is selected', () => {
            (categoryStore.dialogVisible as WritableSignal<boolean>).set(true);
            (categoryStore.selectedCategory as WritableSignal<CategoryInfo | null>).set(null);
            fixture.detectChanges();

            const dialogHeader = fixture.debugElement.query(By.css('.p-dialog-title'));
            expect(dialogHeader.nativeElement.textContent.trim()).toBe('Create Category');
        });

        it('should show "Edit Category" header when a category is selected', () => {
            (categoryStore.dialogVisible as WritableSignal<boolean>).set(true);
            (categoryStore.selectedCategory as WritableSignal<CategoryInfo | null>).set({
                id: 1,
            ...
            const dialogHeader = fixture.debugElement.query(By.css('.p-dialog-title'));
            expect(dialogHeader.nativeElement.textContent.trim()).toBe('Edit Category');
        });
    ...
    describe('Effect and form reactivity', () => {
        it('should patch form values when editing an existing category', () => {
            ...
            expect(component.categoryForm.get('name')?.value).toBe('Existing Category');
    ...
    describe('Form operations', () => {
        ...
        it('should patch form with specific values', () => {
            ...
            expect(component.categoryForm.get('description')?.value).toBe('Patched Description');
        });
