...
describe('CategoryStore', () => {
    ...
    beforeEach(() => {
        ...
        categoryService.create.mockReturnValue(of({ id: 3, name: 'New Category', description: 'New Description' }));
        categoryService.update.mockReturnValue(of({
            id: 1,
    ...
    describe('create', () => {
        ...
        it('should handle error when creating category fails', () => {
            ...
            categoryService.create.mockReturnValue(throwError(() => new Error('Failed to create category')));
    ...
    describe('update', () => {
        ...
        it('should handle error when updating category fails', () => {
            ...
            categoryService.update.mockReturnValue(throwError(() => new Error('Failed to update category')));
        ...
        it('should handle foreign key constraint error when deleting category', () => {
            ...
            const errorResponse = new HttpErrorResponse({
                error: {
                    ...
                    message: 'update or delete on table "categories" violates foreign key constraint "fk_product_category" on table "products" Key (id)=(1) is still referenced from table "products"',
                },
                status: HttpStatusCode.Conflict,
                statusText: 'Conflict',
            });
            ...
            expect(messageService.add).toHaveBeenCalledWith({
                severity: 'error',
                summary: 'Error',
                detail: 'Cannot delete category "Category 1" because it is being used by a product.',
            });
        });
    ...
    describe('deleteAllById', () => {
        ...
        it('should handle foreign key constraint error when deleting multiple categories', () => {
            ...
            categoryService.deleteAllById.mockReturnValue(throwError(() => errorResponse));
        ...
        it('should handle foreign key constraint error with unknown category ID', () => {
            ...
            const errorResponse = new HttpErrorResponse({
                error: {
                    status: HttpStatusCode.Conflict,
                    message: 'update or delete on table "categories" violates foreign key constraint "fk_product_category" on table "products" Key (id)=(3) is still referenced from table "products"',
                },
                status: HttpStatusCode.Conflict,
                statusText: 'Conflict',
            });
            ...
            expect(messageService.add).toHaveBeenCalledWith({
                severity: 'error',
                summary: 'Error',
                detail: 'Cannot delete category "ID 3" because it is being used by a product.',
            });
        });
        ...
        it('should handle foreign key constraint error with missing ID pattern', () => {
            ...
            expect(messageService.add).toHaveBeenCalledWith({
                severity: 'error',
                summary: 'Error',
                detail: 'Cannot delete category "unknown" because it is being used by a product.',
            });
        });
