...
describe('ProductStore', () => {
    ...
    beforeEach(() => {
        ...
        productService.create.mockReturnValue(of({
            id: 3,
            name: 'Product 3',
    ...
    describe('create', () => {
        ...
        it('should handle error when creating product fails', () => {
            ...
            productService.create.mockReturnValue(throwError(() => new Error('Failed to create product')));
    ...
    describe('update', () => {
        ...
        it('should handle error when updating product fails', () => {
            ...
            productService.update.mockReturnValue(throwError(() => new Error('Failed to update product')));
    ...
    describe('deleteAllById', () => {
        ...
        it('should handle error when deleting multiple products', () => {
            ...
            productService.deleteAllById.mockReturnValue(throwError(() => errorResponse));
