...
describe('SaleStore', () => {
    ...
    beforeEach(() => {
        saleService = {
            ...
            generateDailySalesReport: vi.fn().mockName("SaleService.generateDailySalesReport")
        };
    ...
    describe('findAll', () => {
        ...
        it('should handle error when findAll fails', () => {
            saleService.findAll.mockReturnValue(throwError(() => new Error('Error loading sales')));
    ...
    describe('findByDateRange', () => {
        it('should find sales by date range', () => {
            ...
            expect(saleService.findByDateRange).toHaveBeenCalledWith(startDate, endDate);
            expect(store.entities().length).toBe(1);
        });
    });
    ...
    describe('generateDailySalesReport', () => {
        it('should generate a daily sales report', () => {
            ...
            expect(saleService.generateDailySalesReport).toHaveBeenCalledWith(date, exportPath);
