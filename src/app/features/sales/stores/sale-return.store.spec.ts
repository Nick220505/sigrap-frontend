...
describe('SaleReturnStore', () => {
    ...
    describe('loadAll', () => {
        ...
        it('should handle error when loadAll fails', () => {
            ...
            saleReturnService.findAll.mockReturnValue(throwError(() => errorResponse));
    ...
    describe('update', () => {
        it('should update a sale return', () => {
            ...
            expect(saleReturnService.update).toHaveBeenCalledWith(1, mockSaleReturnData);
            expect(messageService.add).toHaveBeenCalledWith({
                severity: 'success',
                summary: 'Success',
    ...
    describe('deleteAllById', () => {
        ...
        it('should handle error when deleting multiple sale returns fails', () => {
            ...
            saleReturnService.deleteAllById.mockReturnValue(throwError(() => errorResponse));
