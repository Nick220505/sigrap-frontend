...
describe('SaleService', () => {
    ...
    it('should find sales by date range', () => {
        ...
        const req = httpMock.expectOne(`${apiUrl}/by-date-range?startDate=${startDate}&endDate=${endDate}`);
        expect(req.request.method).toBe('GET');
        req.flush(mockSales);
    });
    ...
    it('should generate daily sales report with date', () => {
        ...
        const req = httpMock.expectOne(`${apiUrl}/export/daily?date=${formattedDate}`);
        expect(req.request.method).toBe('GET');
        req.flush('Report generated');
    });
    ...
    it('should generate daily sales report with date and export path', () => {
        ...
        const req = httpMock.expectOne(`${apiUrl}/export/daily?date=${formattedDate}&exportPath=${exportPath}`);
        expect(req.request.method).toBe('GET');
        req.flush('Report generated');
    });
});
