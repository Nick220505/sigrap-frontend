...
describe('SalesReturnsTable', () => {
  let component: SalesReturnsTable;
  let fixture: ComponentFixture<SalesReturnsTable>;
  let saleReturnStore: {
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(SalesReturnsTable);
