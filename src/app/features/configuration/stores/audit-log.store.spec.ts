...
describe('AuditLogStore', () => {
    ...
    function createStore(findAllReturnValue = of(mockPageResponse)) {
        ...
        auditLogService = {
            ...
            findByEntityNameAndId: vi.fn().mockName("AuditLogService.findByEntityNameAndId"),
            ...
            findByEntityAndDateRange: vi.fn().mockName("AuditLogService.findByEntityAndDateRange")
        };
        messageService = {
        ...
        auditLogService.findByEntityAndDateRange.mockReturnValue(of(mockPageResponse));
    ...
    describe('findByUsername', () => {
        ...
        it('should handle error when finding audit logs by user fails', () => {
            ...
            auditLogService.findByUsername.mockReturnValue(throwError(() => new Error(errorMessage)));
    ...
    describe('findByEntityName', () => {
        ...
        it('should handle error when finding audit logs by entity fails', () => {
            ...
            const errorStore = createStore(of(emptyPageResponse));
            auditLogService.findByEntityName.mockReturnValue(throwError(() => new Error(errorMessage)));
    ...
    describe('findByAction', () => {
        ...
        it('should handle error when finding audit logs by action fails', () => {
            ...
            const errorStore = createStore(of(emptyPageResponse));
            auditLogService.findByAction.mockReturnValue(throwError(() => new Error(errorMessage)));
    ...
    describe('findByDateRange', () => {
        ...
        it('should handle error when finding audit logs by date range fails', () => {
            ...
            const errorStore = createStore(of(emptyPageResponse));
            auditLogService.findByDateRange.mockReturnValue(throwError(() => new Error(errorMessage)));
