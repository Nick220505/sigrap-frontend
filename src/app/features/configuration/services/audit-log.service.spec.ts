...
describe('AuditLogService', () => {
    ...
    it('should find audit logs by entity name', () => {
        ...
        const req = httpMock.expectOne(`${baseUrl}/by-entity?entityName=${entityName}&page=0&size=10`);
        expect(req.request.method).toBe('GET');
        req.flush(mockPageResponse);
    });
    ...
    it('should find audit logs by action', () => {
        ...
        const req = httpMock.expectOne(`${baseUrl}/by-action?action=${action}&page=0&size=10`);
        expect(req.request.method).toBe('GET');
        req.flush(mockPageResponse);
    });
    ...
    it('should find audit logs by date range', () => {
        ...
        const req = httpMock.expectOne(`${baseUrl}/by-date-range?startDate=${startDate}&endDate=${endDate}&page=0&size=10`);
        expect(req.request.method).toBe('GET');
        req.flush(mockPageResponse);
    });
});
